...
function showScores() {
    ...
    if (quiz.score >= 4) {
        ...
        let quizEndHTML =
            ...
            <div class="main_fish">
           <center>
            <img class="fish_img" src="images/bird/africanGrey1">
            
            <h3 class='score'> AFRICAN GREY</h3>
            <p class='score'> African greys are known as having the outstanding ability to earn a human word and imitate speech, they earned the title "The Einstein of the Bird World".
    ...
    // Cat that doesn't shed
        ...
        <h3 id='score'>Parakeet</h3>
        <p id='score'>Parakeets are one of the top birds worldwide as a pet, they are tiny parrot versions with long tail feathers.
